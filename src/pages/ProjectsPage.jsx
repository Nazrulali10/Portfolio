  ...
  return (
    ...
    >
      ...
      <div className=" flex w-full md:gap-2 justify-center items-center mt-3 md:mt-8 px-0 md:px-10">
        ...
        <div className="overflow-hidden w-full  h-50 md:h-140 flex justify-center items-center rounded-md ">
          <div
      ...
      <p className="mt-2 md:mt-5 text-gray-400 text-xs md:text-sm">
        {project.description}
      </p>
