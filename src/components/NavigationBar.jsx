...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu */}
      <div
        className={`fixed top-0 left-0 w-64 h-screen bg-white shadow-2xl text-base flex flex-col md:hidden items-center justify-center gap-6 font-medium text-gray-800 transition-all duration-500 ${isMenuOpen ? "translate-x-0" : "-translate-x-[110%]"
          }`}
      >
        <button
